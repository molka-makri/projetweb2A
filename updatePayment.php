    ...
    <div class="container mt-5">
        ...
        <form action="" method="POST" onsubmit="return validateForm()">
            ...
            <div class="mb-3">
                ...
                <input type="date" id="datePayment" name="datePayment" class="form-control" value="<?= htmlspecialchars($paiement['datePayment']) ?>" required>
            </div>

            <div class="mb-3">
                <label for="montant" class="form-label">Montant :</label>
                <input type="number" id="montant" name="montant" class="form-control" value="<?= htmlspecialchars($paiement['montant']) ?>" required>
            </div>

            <div class="mb-3">
                <label for="moyenPaiement" class="form-label">Moyen de Paiement :</label>
                <select id="moyenPaiement" name="moyenPaiement" class="form-select" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="numeroCarte" name="numeroCarte" class="form-control" value="<?= htmlspecialchars($paiement['numeroCarte']) ?>" 
                    <?= $paiement['moyenPaiement'] == 'carte_credit' || $paiement['moyenPaiement'] == 'virement' ? 'required' : '' ?>>
            </div>

            <div class="mb-3">
                <label for="statusPaiement" class="form-label">Statut du Paiement :</label>
                <select id="statusPaiement" name="statusPaiement" class="form-select" required>
